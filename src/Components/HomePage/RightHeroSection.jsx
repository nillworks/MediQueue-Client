...
const RightHeroSection = () => {
  return (
    <div className="relative w-full flex justify-center items-center">
      ...
      {/* Main Card */}
      <div className="relative z-20 cursor-pointer bg-white/90 backdrop-blur-xl p-3 sm:p-4 rounded-[28px] sm:rounded-[32px] shadow-[0_20px_60px_rgba(0,0,0,0.08)] border border-white/60 w-full max-w-[320px] sm:max-w-[420px] lg:max-w-[470px] hover:-translate-y-2 transition-all duration-500">
        {/* Image */}
